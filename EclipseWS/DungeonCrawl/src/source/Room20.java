...
public class Room20 extends BasicGameState{
	...
	public Room20(int state){
		
	}
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException{
		bg = new Image("res/graphic/map/20.png");
	}
	...
	public void update(GameContainer gc, StateBasedGame sbg, int delta) throws SlickException{
		...
		//ENTER UP
		if((Player.yCoord <= 0) && (Player.xCoord >= 360) && (Player.xCoord <= 640)) {
			sbg.enterState(13);
			Player.xCoord = 500;
			Player.yCoord = 600;
		}
		//ENET DOWN
		if((Player.yCoord >= 752) && (Player.xCoord >= 360) && (Player.xCoord <= 640)) {
			sbg.enterState(1);
			Player.xCoord = 500;
			Player.yCoord = 80;
		}
